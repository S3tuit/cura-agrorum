...
#define NODE_CORE_READING_AIRTIME_US UINT64_C(97536)
#define NODE_CORE_READING_AIRTIME_CHARGE_US UINT64_C(107290)
...
#define CURAG_ECORE_EACK_SAMPLE_ID UINT16_C(10)
