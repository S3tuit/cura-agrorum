...
#define CURA_LORA_V2_SCHEMA_SHA256 "ece4ec58bad29ddad03be41ccb257ffef960fa11a2df1d9f8650f4eb499de009"
...
#define CURA_LORA_V2_READING_BODY_SIZE 32u
#define CURA_LORA_V2_ACK_BODY_SIZE 1u
#define CURA_LORA_V2_READING_FRAME_SIZE 54u
...
#define CURA_LORA_V2_CLEAR_HEADER_MESSAGE_ID_OFFSET 10u

#define CURA_LORA_V2_NONCE_NODE_ID_OFFSET 0u
#define CURA_LORA_V2_NONCE_MESSAGE_ID_OFFSET 8u
#define CURA_LORA_V2_NONCE_DOMAIN_OFFSET 12u

#define CURA_LORA_V2_READING_SAMPLE_ID_OFFSET 0u
#define CURA_LORA_V2_READING_RUN_MS_OFFSET 4u
#define CURA_LORA_V2_READING_SOIL_0_MV_OFFSET 6u
#define CURA_LORA_V2_READING_SOIL_1_MV_OFFSET 8u
#define CURA_LORA_V2_READING_SOIL_TEMP_0_CENTI_C_OFFSET 10u
#define CURA_LORA_V2_READING_SOIL_TEMP_1_CENTI_C_OFFSET 12u
#define CURA_LORA_V2_READING_ENCLOSURE_CENTI_C_OFFSET 14u
#define CURA_LORA_V2_READING_ENCLOSURE_PRESSURE_PA_OFFSET 16u
#define CURA_LORA_V2_READING_ENCLOSURE_HUMIDITY_CENTI_PCT_OFFSET 20u
#define CURA_LORA_V2_READING_RESET_REASON_OFFSET 22u
#define CURA_LORA_V2_READING_PREVIOUS_CURRENT_TX_ATTEMPTS_OFFSET 23u
#define CURA_LORA_V2_READING_PREVIOUS_AWAKE_MS_OFFSET 24u
#define CURA_LORA_V2_READING_PREVIOUS_CURRENT_DELIVERY_MS_OFFSET 26u
#define CURA_LORA_V2_READING_PREVIOUS_CYCLE_TX_ATTEMPTS_OFFSET 28u
#define CURA_LORA_V2_READING_PREVIOUS_CYCLE_ACCEPTED_READINGS_OFFSET 29u
#define CURA_LORA_V2_READING_FLAGS_OFFSET 30u
